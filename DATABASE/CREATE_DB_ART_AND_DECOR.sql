...
CREATE TABLE `SEO_META` (
    ...
    `SEO_META_TITLE` VARCHAR(150),
    `SEO_META_DESCRIPTION` VARCHAR(500),
    `SEO_META_KEYWORDS` VARCHAR(300),
    `SEO_META_INDEX` BOOLEAN DEFAULT TRUE,
    `SEO_META_FOLLOW` BOOLEAN DEFAULT TRUE,
    ...
    `SEO_META_ENABLED` BOOLEAN DEFAULT TRUE,
    `CREATED_DT` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    `MODIFIED_DT` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `IMAGE_EMBEDDING` (
    ...
    `IMAGE_EMBEDDING_STATUS` VARCHAR(50) NOT NULL DEFAULT 'PENDING',
    `CREATED_DT` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    `MODIFIED_DT` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `PRODUCT_CATEGORY` (
    ...
    `PRODUCT_CATEGORY_CONTENT` LONGTEXT DEFAULT NULL,
    ...
    `PRODUCT_CATEGORY_DISPLAY_ORDER` INT DEFAULT NULL,
...
-- Table: TESTIMONIAL (Customer testimonials / reviews displayed on the website)
